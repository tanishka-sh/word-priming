...
expName = 'Word Priming Task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Tanishka\\OneDrive\\Documents\\2. Courses\\PSY310\\Experiments\\T5_Word Priming Task\\Word Priming Task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    loop = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('word_study.xlsx'), 
        seed=None, 
    )
    ...
    for thisLoop in loop:
        ...
        loop.addData('slider.response', slider.getRating())
        loop.addData('slider.rt', slider.getRT())
